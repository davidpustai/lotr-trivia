...
export const beforeFirstAgeEvents: TimelineEvent[] = [
    ...
    {
        id: "bfa-tulkas-arrives",
        age: "years-of-lamps",
        title: "Tulkas Arrives and Melkor Flees",
        summary:
            "Tulkas the Strong entered Arda last of the Valar, and his laughter and might caused Melkor to flee into the outer darkness.",
        details:
            "Tulkas, the champion of the Valar, came to Arda drawn by the struggle against Melkor. His arrival tipped the balance; Melkor could not withstand his strength and fled beyond the Walls of the World. There was peace for a long age while the Valar shaped Arda and created the Two Lamps.",
        tags: ["divine"],
        significance: 2,
        depth: 2,
        relatedCharacters: ["Tulkas", "Melkor"],
    ...
    },
    {
        id: "bfa-two-trees",
        age: "years-of-trees",
        title: "Creation of the Two Trees of Valinor",
        summary:
            "Yavanna sang and Nienna watered the mound of Ezellohar, and the Two Trees — Telperion and Laurelin — grew, lighting Valinor.",
        details:
            "After the destruction of the Two Lamps and the removal of the Valar to Aman, Yavanna created the Two Trees upon the green mound of Ezellohar. Telperion bore silver light and Laurelin golden; each waxed and waned over seven hours, mingling their light at dawn and dusk. They were the most beautiful things Yavanna ever made.",
        tags: ["creation", "divine"],
        significance: 3,
        depth: 2,
        relatedCharacters: ["Yavanna", "Nienna"],
    ...
    },
    {
        ...
        summary:
            "The Firstborn Children of Ilúvatar awoke beside the lake of Cuiviénen under starlight, the first to see the world.",
        details:
            "By the waters of Cuiviénen in the far east of Middle-earth, the Elves awoke and looked upon the stars. They called themselves the Quendi, 'those who speak'. Oromë the huntsman discovered them and was filled with wonder. But Melkor's spies also found them, and some who wandered alone were taken and corrupted — these, it is said, were the origin of Orcs.",
        tags: ["creation"],
        significance: 3,
        depth: 2,
        relatedCharacters: ["Oromë", "Melkor"],
        relatedLocations: ["Cuiviénen"],
    },
    {
        id: "bfa-great-journey",
        age: "years-of-trees",
        year: "YT 1105",
        title: "The Great Journey of the Elves Begins",
        summary:
            "The Valar summoned the Elves to Valinor, and three kindreds began the long westward march across Middle-earth.",
        details:
            "After the Valar defeated Melkor and imprisoned him in Mandos, Oromë invited the Elves to dwell in the Blessed Realm. Three ambassadors — Ingwë, Finwë, and Elwë — went to Valinor and returned filled with desire for the Light. The three hosts of the Vanyar, Noldor, and Teleri began the Great Journey, though many Elves refused the summons and became the Avari.",
        tags: ["quest"],
        significance: 2,
        depth: 2,
        relatedCharacters: ["Ingwë", "Finwë", "Elwë", "Oromë"],
    },
    {
        id: "bfa-aule-dwarves",
        age: "years-of-trees",
        title: "Aulë Creates the Dwarves in Secret",
        summary:
            "Aulë the Smith, impatient for the Children of Ilúvatar, fashioned the Seven Fathers of the Dwarves in secret beneath a mountain.",
        details:
            "Aulë desired to have pupils to teach his crafts, and in his impatience he created the Dwarves. When Ilúvatar confronted him, Aulë repented and raised his hammer to destroy his creation. But Ilúvatar had mercy and gave the Dwarves true life, though they were to sleep until after the Elves awoke. Durin the Deathless was the eldest of the Seven Fathers.",
        tags: ["creation", "divine"],
        significance: 2,
        depth: 2,
        relatedCharacters: ["Aulë", "Ilúvatar", "Durin"],
    },
    {
        id: "bfa-ents-created",
        age: "years-of-trees",
        title: "Yavanna Asks for the Ents",
        summary:
            "Yavanna, grieving that her trees would be defenseless, petitioned Ilúvatar, and the Ents were conceived as shepherds of the forests.",
        details:
            "After learning that Aulë had created the Dwarves — who would fell trees for their forges — Yavanna appealed to Manwë, and through the Music of the Ainur it was revealed that spirits would inhabit the great trees. These became the Ents, the Shepherds of the Trees, oldest of all walking creatures in Middle-earth.",
        tags: ["creation", "divine"],
        significance: 1,
        depth: 2,
        relatedCharacters: ["Yavanna", "Manwë"],
    },
    {
        id: "bfa-utumno-destroyed",
        age: "years-of-trees",
        year: "YT 1099",
        title: "War of the Powers — Utumno Destroyed",
        summary:
            "The Valar made war upon Melkor for the sake of the Elves, besieging and destroying his great fortress of Utumno.",
        details:
            "To protect the newly-awakened Elves, the Valar assailed Melkor. The Battle of the Powers shook Middle-earth and reshaped its lands. Utumno, Melkor's first and greatest fortress, was broken and unroofed, though its deepest pits were not wholly explored. Melkor was captured and bound with the chain Angainor, then imprisoned in the Halls of Mandos for three ages.",
        tags: ["war", "divine"],
        significance: 2,
        depth: 2,
        relatedCharacters: ["Melkor", "Tulkas", "Oromë"],
        relatedLocations: ["Utumno"],
    },
    {
        id: "bfa-varda-stars",
        age: "years-of-trees",
        year: "YT 1050",
        title: "Varda Kindles New Stars for the Elves",
        summary:
            "Varda, Queen of the Valar, created new and brighter stars from the dews of Telperion, so the Elves would awake under glorious starlight.",
        details:
            "In preparation for the awakening of the Elves, Varda set new stars in the sky, including the Valacirca (Sickle of the Valar, the Big Dipper), which she placed in the north as a challenge to Melkor. The Elves forever revered Varda above all the Valar, calling her Elbereth Gilthoniel — 'Star-queen, Star-kindler'.",
        tags: ["creation", "divine"],
        significance: 2,
        depth: 2,
        relatedCharacters: ["Varda"],
        relatedLocations: ["Valinor"],
    },
];
