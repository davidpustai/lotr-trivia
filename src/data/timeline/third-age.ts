...
export const thirdAgeEvents: TimelineEvent[] = [
    ...
    },
    {
        ...
        title: "Bilbo Finds the One Ring",
        summary:
            "Lost in the goblin tunnels beneath the Misty Mountains, Bilbo Baggins found a golden ring and won the riddle-game against Gollum.",
        details:
            "Bilbo stumbled upon the Ring in a dark passage after the goblins captured Thorin's company. In the riddle-contest with Gollum, the Ring's power of invisibility saved Bilbo's life. He kept the Ring secret for sixty years. This chance finding was, as Gandalf later said, the most unlikely event in all of Middle-earth — and perhaps not chance at all.",
        tags: ["ring", "quest"],
        significance: 3,
        depth: 2,
        relatedCharacters: ["Bilbo", "Gollum"],
        relatedLocations: ["Misty Mountains"],
    },
    {
        id: "ta-bilbo-farewell",
        age: "third-age",
        year: "TA 3001",
        title: "Bilbo's Farewell Party",
        summary:
            "Bilbo celebrated his 111th birthday with a magnificent party, then vanished using the Ring, leaving it behind for Frodo at Gandalf's urging.",
        tags: ["ring"],
        significance: 2,
        depth: 2,
        relatedCharacters: ["Bilbo", "Frodo", "Gandalf"],
        relatedLocations: ["The Shire"],
    },
    {
        id: "ta-hobbits-reach-bree",
        age: "third-age",
        year: "TA 3018",
        title: "The Hobbits Reach Bree and Meet Strider",
        summary:
            "Frodo, Sam, Merry, and Pippin arrived at the Prancing Pony in Bree, where they met Aragorn disguised as the Ranger called Strider.",
        tags: ["quest"],
        significance: 2,
        depth: 2,
        relatedCharacters: ["Frodo", "Aragorn", "Sam", "Merry", "Pippin"],
        relatedLocations: ["Bree"],
    },
    {
        id: "ta-gandalf-balrog",
        age: "third-age",
        year: "TA 3019",
        title: "Gandalf Falls with the Balrog in Moria",
        summary:
            "On the Bridge of Khazad-dûm, Gandalf confronted Durin's Bane and fell into the abyss, fighting the Balrog for ten days before slaying it on Zirakzigil.",
        details:
            "'You cannot pass!' Gandalf broke the bridge and the Balrog fell, but its whip caught Gandalf's legs and pulled him down. They fought from the lowest dungeon to the highest peak of the Silvertine, where Gandalf slew the Balrog. Gandalf himself died but was sent back by the Valar as Gandalf the White.",
        tags: ["quest", "divine"],
        significance: 3,
        depth: 2,
        relatedCharacters: ["Gandalf"],
        relatedLocations: ["Moria"],
    },
    {
        id: "ta-breaking-fellowship",
        age: "third-age",
        ...
        summary:
            "Boromir tried to take the Ring from Frodo. Frodo fled with Sam toward Mordor alone. Uruk-hai attacked, killing Boromir as he defended Merry and Pippin.",
        tags: ["quest", "tragedy"],
        significance: 3,
        depth: 2,
        relatedCharacters: ["Boromir", "Frodo", "Aragorn", "Sam"],
        relatedLocations: ["Amon Hen"],
    },
    {
        id: "ta-theoden-freed",
        age: "third-age",
        year: "TA 3019",
        title: "Théoden Freed from Saruman's Influence",
        summary:
            "Gandalf the White arrived at Edoras and broke Saruman's hold over King Théoden, who had been made to seem old and helpless by Gríma Wormtongue's counsel.",
        tags: ["corruption", "kingdom"],
        significance: 2,
        depth: 2,
        relatedCharacters: ["Gandalf", "Théoden", "Saruman", "Gríma"],
        relatedLocations: ["Edoras"],
    },
    {
        id: "ta-ents-march-isengard",
        age: "third-age",
        year: "TA 3019",
        title: "The Ents March on Isengard",
        summary:
            "After the Entmoot decided that Saruman must be stopped, the Ents marched on Isengard and destroyed its walls and industry with flood and root-strength.",
        details:
            "Treebeard led the Ents and Huorns against Isengard after Saruman's Orcs had felled many trees of Fangorn. They broke the dam of the River Isen and flooded the ring of Isengard, trapping Saruman in the tower of Orthanc. It was one of the most decisive moments of the War, eliminating Saruman's army.",
        tags: ["war"],
        significance: 2,
        depth: 2,
        relatedCharacters: ["Treebeard", "Saruman", "Merry", "Pippin"],
        relatedLocations: ["Isengard", "Fangorn Forest"],
    },
    {
        id: "ta-shelob-attacks-frodo",
        age: "third-age",
        year: "TA 3019",
        title: "Shelob Attacks Frodo in Cirith Ungol",
        summary:
            "Gollum led Frodo and Sam into Shelob's lair. The great spider stung Frodo, but Sam fought her off with the Phial of Galadriel and Sting.",
        tags: ["quest"],
        significance: 2,
        depth: 2,
        relatedCharacters: ["Frodo", "Sam", "Gollum", "Shelob"],
        relatedLocations: ["Cirith Ungol"],
    },
    {
        id: "ta-faramir-osgiliath",
        age: "third-age",
        year: "TA 3019",
        title: "Faramir Defends Osgiliath",
        summary:
            "Faramir led a desperate retreat from Osgiliath as Mordor's armies crossed the Anduin, nearly dying from a Southron arrow during the withdrawal.",
        tags: ["war"],
        significance: 1,
        depth: 2,
        relatedCharacters: ["Faramir", "Denethor"],
        relatedLocations: ["Osgiliath"],
    },
    {
        id: "ta-aragorn-paths-dead",
        age: "third-age",
        year: "TA 3019",
        title: "Aragorn Takes the Paths of the Dead",
        summary:
            "Aragorn summoned the oathbreaker Dead Men of Dunharrow to fulfill their ancient vow, leading a ghost army to defeat the Corsairs of Umbar at Pelargir.",
        tags: ["war", "quest"],
        significance: 2,
        depth: 2,
        relatedCharacters: ["Aragorn", "Legolas", "Gimli"],
        relatedLocations: ["Paths of the Dead", "Pelargir"],
    },
    {
        id: "ta-scouring-shire",
        age: "third-age",
        ...
        title: "The Scouring of the Shire",
        summary:
            "The four Hobbits returned to find the Shire occupied by Saruman's ruffians and led a revolt to liberate their homeland.",
        details:
            "Saruman, having escaped Orthanc, took control of the Shire through 'Sharkey's men'. The returning Hobbits — now battle-hardened — roused the Shire-folk. In the Battle of Bywater, the ruffians were defeated. Saruman was killed by Gríma Wormtongue on Frodo's own doorstep. This was the last act of the War of the Ring.",
        tags: ["war", "kingdom"],
        significance: 2,
        depth: 2,
        relatedCharacters: ["Frodo", "Sam", "Merry", "Pippin", "Saruman"],
        relatedLocations: ["The Shire"],
    },
    {
        id: "ta-frodo-sails-west",
        age: "third-age",
        year: "TA 3021",
        title: "Frodo Sails to the Undying Lands",
        summary:
            "Frodo, bearing wounds that would never heal in Middle-earth, sailed from the Grey Havens with Gandalf, Bilbo, Galadriel, and Elrond.",
        details:
            "On September 29, TA 3021, the Last Riding of the Keepers of the Rings departed from the Grey Havens. Frodo had been granted passage to Valinor in recognition of his sacrifice as Ring-bearer. Sam, who accompanied Frodo to the harbor, returned to Bag End and said: 'Well, I'm back.' It was the end of the Third Age.",
        tags: ["quest"],
        significance: 3,
        depth: 2,
        relatedCharacters: ["Frodo", "Gandalf", "Bilbo", "Sam", "Galadriel", "Elrond"],
        relatedLocations: ["Grey Havens"],
    },
];
