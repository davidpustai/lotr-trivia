...
export const secondAgeEvents: TimelineEvent[] = [
    ...
    {
        id: "sa-celebrimbor-three-rings",
        age: "second-age",
        year: "SA 1590",
        title: "Celebrimbor Forges the Three Elven Rings",
        summary:
            "Celebrimbor, grandson of Fëanor, forged the Three Rings of Power alone, without Sauron's touch — Narya, Nenya, and Vilya.",
        details:
            "The Three were the mightiest of the Rings of Power save the One. Because Sauron never touched them, they were free of his direct corruption, though still subject to the One Ring. Celebrimbor gave Vilya and Narya to Gil-galad, and Nenya to Galadriel. They were rings of preservation and healing, not domination.",
        tags: ["ring", "artifact"],
        significance: 2,
        depth: 2,
        relatedCharacters: ["Celebrimbor", "Galadriel", "Gil-galad"],
        relatedLocations: ["Eregion"],
    },
    {
        id: "sa-one-ring-forged",
        age: "second-age",
        ...
        summary:
            "In the fires of Orodruin, Sauron forged the One Ring, pouring much of his own power and will into it to dominate all other Ring-bearers.",
        details:
            "Sauron crafted the One Ring in secret in the volcanic fires of Mount Doom. The moment he put it on, the Elves became aware of him and removed their Rings. The inscription 'Ash nazg durbatulûk' — One Ring to rule them all — was written in Black Speech with Tengwar letters. Sauron bound his fate to the Ring; it became both his greatest weapon and his greatest vulnerability.",
        tags: ["ring", "artifact", "corruption"],
        significance: 3,
        depth: 2,
        relatedCharacters: ["Sauron"],
        relatedLocations: ["Mount Doom"],
    },
    {
        id: "sa-ar-pharazon-captures-sauron",
        age: "second-age",
        year: "SA 3262",
        title: "Ar-Pharazôn Captures Sauron",
        summary:
            "The last King of Númenor led such a mighty host to Middle-earth that Sauron's own servants deserted him, and he surrendered willingly.",
        details:
            "Ar-Pharazôn the Golden, mightiest of all Men, came with such overwhelming force that Sauron could not resist. But Sauron's surrender was a stratagem — he allowed himself to be taken as a hostage to Númenor, knowing he could corrupt the kingdom from within. He still wore the One Ring.",
        tags: ["corruption", "kingdom"],
        significance: 2,
        depth: 2,
        relatedCharacters: ["Ar-Pharazôn", "Sauron"],
        relatedLocations: ["Númenor"],
    },
    {
        id: "sa-sauron-corrupts-numenor",
        age: "second-age",
        year: "SA 3262",
        title: "Sauron Corrupts Númenor From Within",
        summary:
            "As a prisoner, Sauron rose to become Ar-Pharazôn's chief counselor, turning Númenor to the worship of Morgoth and human sacrifice.",
        details:
            "Within fifty years, Sauron had risen from prisoner to high priest. He built a great temple to Morgoth where the White Tree Nimloth was burned and human sacrifices offered. He convinced Ar-Pharazôn that immortality could be seized by force, leading to the Armament against Valinor. Only the Faithful, led by Elendil's house, resisted.",
        tags: ["corruption"],
        significance: 2,
        depth: 2,
        relatedCharacters: ["Sauron", "Ar-Pharazôn"],
        relatedLocations: ["Númenor"],
    },
    {
        id: "sa-faithful-sail",
        age: "second-age",
        year: "SA 3319",
        title: "The Faithful Escape the Downfall of Númenor",
        summary:
            "As Númenor was destroyed by Ilúvatar, Elendil and his sons escaped with nine ships, the palantíri, and a seedling of the White Tree.",
        details:
            "When Ar-Pharazôn set foot upon the shores of Aman, Ilúvatar changed the shape of the world. Númenor was swallowed by the sea, and the Undying Lands were removed from the circles of the world forever. Elendil's ships were borne by a great storm to the shores of Middle-earth. Sauron's body was destroyed in the Downfall, but his spirit endured through the One Ring.",
        tags: ["kingdom", "tragedy"],
        significance: 3,
        depth: 2,
        relatedCharacters: ["Elendil", "Isildur", "Anárion"],
        relatedLocations: ["Númenor"],
    },
    {
        id: "sa-elendil-arnor",
        age: "second-age",
        year: "SA 3320",
        title: "Elendil Establishes Arnor and Gondor",
        summary:
            "Elendil founded the kingdom of Arnor in the north, while his sons Isildur and Anárion founded Gondor in the south — the Realms in Exile.",
        tags: ["kingdom"],
        significance: 2,
        depth: 2,
        relatedCharacters: ["Elendil", "Isildur", "Anárion"],
        relatedLocations: ["Arnor", "Gondor"],
    },
    {
        id: "sa-white-tree-minas-ithil",
        age: "second-age",
        year: "SA 3320",
        title: "Isildur Plants the White Tree in Minas Ithil",
        summary:
            "Isildur planted a seedling of the White Tree Nimloth in Minas Ithil, the Tower of the Moon, as a memorial of Númenor.",
        tags: ["kingdom"],
        significance: 1,
        depth: 2,
        relatedCharacters: ["Isildur"],
        relatedLocations: ["Minas Ithil"],
    },
    {
        id: "sa-gil-galad-elendil-fall",
        age: "second-age",
        year: "SA 3441",
        title: "Gil-galad and Elendil Fall Defeating Sauron",
        summary:
            "In the final combat on the slopes of Orodruin, both Gil-galad and Elendil were slain, but they overthrew Sauron. Isildur cut the Ring from his hand.",
        details:
            "The siege of Barad-dûr lasted seven years before Sauron emerged. In the final combat, Gil-galad was burned to death by Sauron's heat, and Elendil was crushed. Narsil, Elendil's sword, broke beneath him. Isildur took up the hilt-shard and cut the One Ring from Sauron's hand, and his spirit fled. But Isildur claimed the Ring as weregild for his father.",
        tags: ["war", "ring"],
        significance: 3,
        depth: 2,
        relatedCharacters: ["Gil-galad", "Elendil", "Sauron", "Isildur"],
        relatedLocations: ["Mount Doom", "Barad-dûr"],
    },
];
