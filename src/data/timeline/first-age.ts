...
export const firstAgeEvents: TimelineEvent[] = [
    ...
    {
        id: "fa-oath-of-feanor",
        age: "first-age",
        year: "FA 1",
        title: "The Oath of Fëanor",
        summary:
            "Fëanor and his seven sons swore a terrible oath to recover the Silmarils, invoking Ilúvatar and the Everlasting Darkness upon any who kept a Silmaril from them.",
        details:
            "This oath, sworn in the name of Ilúvatar himself, bound Fëanor's sons irrevocably. It drove them to commit the worst atrocities of the First Age — the Kinslayings at Alqualondë, Doriath, and the Havens of Sirion. Even after Fëanor's death, his sons could not escape their oath, and it led to the ruin of nearly every Elven realm.",
        tags: ["tragedy", "artifact"],
        significance: 3,
        depth: 2,
        relatedCharacters: ["Fëanor", "Maedhros", "Maglor"],
        relatedLocations: ["Tirion"],
    },
    {
        id: "fa-fingon-rescues-maedhros",
        age: "first-age",
        year: "FA 5",
        title: "Fingon Rescues Maedhros from Thangorodrim",
        summary:
            "Fingon climbed Thangorodrim alone and, with the aid of Thorondor the eagle, rescued Maedhros who had hung by his wrist for thirty years.",
        details:
            "Morgoth captured Maedhros and hung him by his right hand from a cliff of Thangorodrim. Fingon, despite the betrayal at Losgar, went alone to rescue his friend. When he could not reach him, Maedhros begged for death. Fingon prayed to Manwë, and Thorondor carried him up. He had to cut off Maedhros's hand to free him.",
        tags: ["quest"],
        significance: 2,
        depth: 2,
        relatedCharacters: ["Fingon", "Maedhros", "Thorondor"],
        relatedLocations: ["Thangorodrim"],
    },
    {
        id: "fa-beren-meets-luthien",
        age: "first-age",
        year: "FA 465",
        title: "Beren Meets Lúthien in Neldoreth",
        summary:
            "Beren stumbled upon Lúthien dancing in the forest of Neldoreth and fell in love — the beginning of the greatest love story of the Elder Days.",
        tags: ["quest"],
        significance: 2,
        depth: 2,
        relatedCharacters: ["Beren", "Lúthien"],
        relatedLocations: ["Doriath"],
    },
    {
        id: "fa-thingol-silmaril-demand",
        age: "first-age",
        year: "FA 465",
        title: "Thingol Demands a Silmaril as Bride-Price",
        summary:
            "King Thingol set the price for Lúthien's hand: a Silmaril from Morgoth's crown — believing the quest impossible and hoping to be rid of Beren.",
        tags: ["quest", "artifact"],
        significance: 2,
        depth: 2,
        relatedCharacters: ["Thingol", "Beren", "Lúthien"],
        relatedLocations: ["Menegroth"],
    },
    {
        id: "fa-beren-luthien-morgoth",
        age: "first-age",
        year: "FA 466",
        title: "Beren and Lúthien Before Morgoth's Throne",
        summary:
            "Lúthien sang Morgoth to sleep upon his throne, and Beren cut a Silmaril from his iron crown — the only one ever recovered from Morgoth.",
        details:
            "Disguised as a bat and a wolf, Lúthien and Beren entered Angband. Lúthien sang a song of such power that all of Angband was cast into slumber. Beren cut a Silmaril from the crown with the knife Angrist, but the blade snapped when he tried for a second. At the gates, the great wolf Carcharoth bit off Beren's hand — Silmaril and all.",
        tags: ["quest", "artifact"],
        significance: 3,
        depth: 2,
        relatedCharacters: ["Beren", "Lúthien", "Morgoth"],
        relatedLocations: ["Angband"],
    },
    {
        id: "fa-aredhel-eol",
        age: "first-age",
        year: "FA 316",
        title: "Aredhel Captured by Eöl the Dark Elf",
        summary:
            "Aredhel left Gondolin and was ensnared by the Dark Elf Eöl in Nan Elmoth, bearing him a son — Maeglin, who would later betray Gondolin.",
        tags: ["tragedy"],
        significance: 1,
        depth: 2,
        relatedCharacters: ["Aredhel", "Eöl", "Maeglin", "Turgon"],
        relatedLocations: ["Gondolin", "Nan Elmoth"],
    },
    {
        id: "fa-turin-slays-glaurung",
        age: "first-age",
        year: "FA 499",
        title: "Túrin Slays Glaurung the Dragon",
        summary:
            "Túrin Turambar slew Glaurung the Father of Dragons, but was destroyed by the truth the dragon had concealed about his sister Niënor.",
        details:
            "Túrin hid beneath the ravine of Cabed-en-Aras and drove his black sword Gurthang into the dragon's belly. Glaurung's dying words revealed that Níniel, Túrin's wife, was his sister Niënor under a spell of forgetfulness. She cast herself into the ravine; Túrin fell upon his own sword.",
        tags: ["tragedy", "war"],
        significance: 2,
        depth: 2,
        relatedCharacters: ["Túrin Turambar", "Glaurung", "Niënor"],
        relatedLocations: ["Brethil"],
    },
    {
        id: "fa-hurin-released",
        age: "first-age",
        year: "FA 500",
        title: "Húrin Released After 28 Years of Captivity",
        summary:
            "Morgoth released Húrin after twenty-eight years, during which he had been forced to watch the ruin of his children through Morgoth's power.",
        tags: ["tragedy"],
        significance: 2,
        depth: 2,
        relatedCharacters: ["Húrin", "Morgoth"],
        relatedLocations: ["Thangorodrim"],
    },
    {
        id: "fa-nirnaeth-detail",
        age: "first-age",
        year: "FA 472",
        title: "Nirnaeth Arnoediad — The Battle of Unnumbered Tears",
        summary:
            "The fifth and most devastating battle of the Wars of Beleriand broke the power of the Elven kingdoms when Easterling treachery shattered the alliance.",
        details:
            "Maedhros formed a great alliance of Elves, Men, and Dwarves for a final assault on Morgoth. But Ulfang's Easterlings betrayed the host at the crucial moment. Fingon was slain by Gothmog. Húrin's famous last stand — crying 'Aurë entuluva! Day shall come again!' — could not turn the tide.",
        tags: ["war", "tragedy"],
        significance: 3,
        depth: 2,
        relatedCharacters: ["Fingon", "Maedhros", "Húrin", "Gothmog"],
        relatedLocations: ["Anfauglith"],
    },
    {
        id: "fa-earendil-voyage",
        age: "first-age",
        year: "FA 542",
        title: "Eärendil's Voyage to Valinor",
        summary:
            "Eärendil, bearing a Silmaril upon his brow, sailed to Valinor and pleaded before the Valar to aid Middle-earth against Morgoth.",
        tags: ["quest", "divine"],
        significance: 3,
        depth: 2,
        relatedCharacters: ["Eärendil", "Elwing"],
    ...
    },
    {
        ...
        title: "The War of Wrath",
        summary:
            "The Host of Valinor marched against Morgoth in the greatest battle in the history of Arda, lasting decades and sinking all of Beleriand beneath the sea.",
        tags: ["war", "divine"],
        significance: 3,
        depth: 2,
        relatedCharacters: ["Eönwë", "Morgoth"],
        relatedLocations: ["Beleriand", "Angband"],
    },
    {
        id: "fa-ancalagon-destroyed",
        age: "first-age",
        year: "FA 587",
        title: "Ancalagon the Black Destroyed",
        summary:
            "Eärendil in his flying ship slew Ancalagon the Black, greatest of all dragons, whose fall broke the towers of Thangorodrim.",
        tags: ["war"],
        significance: 2,
        depth: 2,
        relatedCharacters: ["Eärendil", "Ancalagon", "Morgoth"],
        relatedLocations: ["Thangorodrim"],
    },
];
