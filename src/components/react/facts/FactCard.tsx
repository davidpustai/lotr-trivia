    ...
    return (
        <div className="rounded-lg border border-[var(--color-border)] bg-[var(--color-bg-card)] p-4 transition-colors hover:border-[var(--color-border-light)] hover:bg-[var(--color-bg-card-hover)]">
            <div className="mb-2 flex items-start justify-between gap-2">
                <span className="rounded bg-[var(--color-bg-secondary)] px-2 py-0.5 text-xs font-semibold tracking-wider text-[var(--color-shire-green)] uppercase">
                    {CATEGORY_LABELS[fact.category]}
                </span>
                {fact.quizPotential && (
                    <span className="flex shrink-0 items-center gap-1 rounded bg-[var(--color-gold-dim)]/30 px-2 py-0.5 text-xs font-semibold text-[var(--color-gold)]">
